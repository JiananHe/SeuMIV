...
{
public:
	SeriesVisualizer(QWidget *, QString, QWidget* );
	~SeriesVisualizer();
...
inline SeriesVisualizer::SeriesVisualizer(QWidget * vtk_frame, QString name, QWidget * slider_frame)
{
...
inline void SeriesVisualizer::visualizeData()
{
	...
	myInteractorStyle->SetSliderSlices(dicom_slider, slider_max_label, slider_cur_label);
